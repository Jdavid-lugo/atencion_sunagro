...
class SettingsTableSeeder extends Seeder
{
    ...
    public function getDefaults()
    {
        return [
            ...
            'email.header'           => 'Caso actualizado',
            'email.signoff'          => 'Gracias por su paciencia!',
            'email.signature'        => 'Sunagro Vanguardia.',
            'email.dashboard'        => 'Mi escritorio',
            ...
            'email.footer'           => 'Superintendencia nacional de gestion agroalimentaria',
            'email.footer_link'      => 'https://sunagro.gob.ve',
