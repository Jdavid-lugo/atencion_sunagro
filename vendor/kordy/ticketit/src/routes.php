...
Route::group(['middleware' => \Kordy\Ticketit\Helpers\LaravelVersion::authMiddleware()], function () use ($main_route, $main_route_path, $admin_route, $admin_route_path) {
    ...
    Route::group(['middleware' => 'Kordy\Ticketit\Middleware\IsAdminMiddleware'], function () use ($admin_route, $admin_route_path) {
        //Ticket admin index route (ex. http://url/atencion-admin/)
        ...
        //Ticket statuses admin routes (ex. http://url/atencion-admin/status)
        ...
        //Ticket priorities admin routes (ex. http://url/atencion-admin/priority)
        ...
        //Agents management routes (ex. http://url/atencion-admin/agent)
 ...
 "$admin_route.category.store",
        ...
        //Settings configuration routes (ex. http://url/atencion-admin/configuration)
        ...
        //Administrators configuration routes (ex. http://url/atencion-admin/administrators)
        ...
        //Tickets demo data route (ex. http://url/atencion-admin/demo-seeds/)
